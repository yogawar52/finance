...
@section('content')
    ...
    <div class="max-w-xl mx-auto px-6 py-8">
        ...
        <form action="{{ route('categories.store') }}" method="POST" class="bg-white rounded-xl shadow p-6">
            ...
            <div class="mb-4">
                ...
                <input type="text" name="name" value="{{ old('name') }}" placeholder="Contoh: Transportasi"
            ...
            <div class="mb-6">
                ...
                <select name="parent_id" id="parent_id" class="w-full border rounded-lg px-3 py-2">
                    ...
                    @foreach ($categories as $category)
                        <option value="{{ $category->id }}" data-type="{{ $category->type }}" @selected(old('parent_id') == $category->id)>
                            {{ $category->name }}
